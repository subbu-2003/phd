...
fetch("visitusCard.html").then((response)=> response.text()).then((data) => {
    document.getElementById("visitusCard").innerHTML = data;
    // call function to set active class after navbar is loaded
    setActiveNav();
});

fetch("whatsapp.html").then((response)=> response.text()).then((data) => {
